# 👋 Willkommen bei du-it (Dirk Ulrich)

Ich bin Java-Backend-Entwickler mit Fokus auf Spring (Boot), Microservices, REST-APIs, Containerisierung (Docker) und Orchestrierung (Kubernetes, OpenShift).  
...
🌐 [LinkedIn-Profil](https://www.linkedin.com/in/du-it-dirk-ulrich/)
